...
VL_INLINE_OPT void Vcpu___024root___sequent__TOP__0(Vcpu___024root* vlSelf) {
    ...
    if (((IData)(vlSelf->cpu__DOT__mem_write_d) & (0U 
        ...
        __Vdlyvdim0__cpu__DOT__u_memory__DOT__data_mem__DOT__data_array__v0 
            = (0x1ffffU & vlSelf->cpu__DOT__alu_result_e);
        ...
        __Vdlyvdim0__cpu__DOT__u_memory__DOT__data_mem__DOT__data_array__v1 
            = (0x1ffffU & ((IData)(1U) + vlSelf->cpu__DOT__alu_result_e));
        ...
        __Vdlyvdim0__cpu__DOT__u_memory__DOT__data_mem__DOT__data_array__v2 
            = (0x1ffffU & ((IData)(2U) + vlSelf->cpu__DOT__alu_result_e));
        ...
        __Vdlyvdim0__cpu__DOT__u_memory__DOT__data_mem__DOT__data_array__v3 
            = (0x1ffffU & ((IData)(3U) + vlSelf->cpu__DOT__alu_result_e));
    }
...
VL_INLINE_OPT QData Vcpu___024root___change_request_1(Vcpu___024root* vlSelf) {
    ...
    __req |= ((vlSelf->cpu__DOT__u_decode__DOT__cu__DOT__alu_logic ^ vlSelf->__Vchglast__TOP__cpu__DOT__u_decode__DOT__cu__DOT__alu_logic)
         | (vlSelf->cpu__DOT__u_execute__DOT__src_b_e ^ vlSelf->__Vchglast__TOP__cpu__DOT__u_execute__DOT__src_b_e));
    VL_DEBUG_IF( if(__req && ((vlSelf->cpu__DOT__u_decode__DOT__cu__DOT__alu_logic ^ vlSelf->__Vchglast__TOP__cpu__DOT__u_decode__DOT__cu__DOT__alu_logic))) VL_DBG_MSGF("        CHANGE: ../../rtl/cu/control_unit.sv:18: cpu.u_decode.cu.alu_logic\n"); );
    VL_DEBUG_IF( if(__req && ((vlSelf->cpu__DOT__u_execute__DOT__src_b_e ^ vlSelf->__Vchglast__TOP__cpu__DOT__u_execute__DOT__src_b_e))) VL_DBG_MSGF("        CHANGE: ../../rtl/sub_top_files/execute.sv:27: cpu.u_execute.src_b_e\n"); );
    // Final
    vlSelf->__Vchglast__TOP__cpu__DOT__u_decode__DOT__cu__DOT__alu_logic 
