...
VL_ATTR_COLD void Vcpu___024root___ctor_var_reset(Vcpu___024root* vlSelf) {
    ...
    vlSelf->debug_pc_f = VL_RAND_RESET_I(32);
    vlSelf->debug_instr_f = VL_RAND_RESET_I(32);
    vlSelf->cpu__DOT__pc_src_e = VL_RAND_RESET_I(1);
    vlSelf->cpu__DOT__pc_f = VL_RAND_RESET_I(32);
    vlSelf->cpu__DOT__instr_f = VL_RAND_RESET_I(32);
    ...
    vlSelf->cpu__DOT__u_fetch__DOT__dbg_count = VL_RAND_RESET_I(4);
    ...
    vlSelf->cpu__DOT__u_execute__DOT__fwd_aluop1_raw = VL_RAND_RESET_I(32);
    ...
    vlSelf->cpu__DOT__u_execute__DOT__divider__DOT__rem = VL_RAND_RESET_Q(33);
    vlSelf->cpu__DOT__u_execute__DOT__divider__DOT__quo = VL_RAND_RESET_I(32);
    vlSelf->cpu__DOT__u_execute__DOT__divider__DOT__div_shift = VL_RAND_RESET_I(32);
    vlSelf->cpu__DOT__u_execute__DOT__divider__DOT__den = VL_RAND_RESET_Q(33);
    ...
    vlSelf->cpu__DOT__u_execute__DOT__divider__DOT__unnamedblk1__DOT__rem_next = VL_RAND_RESET_Q(33);
    ...
    vlSelf->__Vdlyvdim0__cpu__DOT__u_decode__DOT__rf__DOT__ram_array__v0 = 0;
    vlSelf->__Vdlyvval__cpu__DOT__u_decode__DOT__rf__DOT__ram_array__v0 = VL_RAND_RESET_I(32);
    vlSelf->__Vdlyvset__cpu__DOT__u_decode__DOT__rf__DOT__ram_array__v0 = 0;
    vlSelf->__Vdly__cpu__DOT__u_execute__DOT__divider__DOT__quo = VL_RAND_RESET_I(32);
