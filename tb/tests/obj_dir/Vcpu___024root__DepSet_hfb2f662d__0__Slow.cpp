...
VL_ATTR_COLD void Vcpu___024root___settle__TOP__0(Vcpu___024root* vlSelf) {
    ...
    vlSelf->cpu__DOT__alu_result_e = ((8U & (IData)(vlSelf->cpu__DOT__alu_control_d))
                                       ? ((4U & (IData)(vlSelf->cpu__DOT__alu_control_d))
                                           ? 0U : (
                                                   (2U 
    ...
    if ((0x40U & vlSelf->cpu__DOT__ins)) {
        if (VL_LIKELY((0x20U & vlSelf->cpu__DOT__ins))) {
            if (VL_UNLIKELY((0x10U & vlSelf->cpu__DOT__ins))) {
                VL_WRITEF("[%0t] %%Error: main_decoder.sv:91: Assertion failed in %Ncpu.u_decode.cu.decoder_1: OPcode out of range!\n",
                          64,VL_TIME_UNITED_Q(1),-12,
                          vlSymsp->name());
                VL_STOP_MT("../../rtl/cu/main_decoder.sv", 91, "");
    ...
    if ((0U == (IData)(vlSelf->cpu__DOT__u_decode__DOT__imm_src_d))) {
        vlSelf->cpu__DOT__imm_ext_d = ((vlSelf->cpu__DOT__ins 
                                        >> 0x1fU) ? 
                                       (0xfffff000U 
                                        | (vlSelf->cpu__DOT__ins 
                                           >> 0x14U))
                                        : (vlSelf->cpu__DOT__ins 
                                           >> 0x14U));
    } else if ((1U == (IData)(vlSelf->cpu__DOT__u_decode__DOT__imm_src_d))) {
        vlSelf->cpu__DOT__imm_ext_d = ((vlSelf->cpu__DOT__ins 
                                        >> 0x1fU) ? 
                                       (0xfffff000U 
                                        | ((0xfe0U 
                                        ...
                                        : (vlSelf->cpu__DOT__ins 
                                           >> 0x14U));
    } else if ((2U == (IData)(vlSelf->cpu__DOT__u_decode__DOT__imm_src_d))) {
        vlSelf->cpu__DOT__imm_ext_d = ((vlSelf->cpu__DOT__ins 
                                        >> 0x1fU) ? 
                                       (0xffffe000U 
                                        | ((0x1000U 
                                           ...
                                           | ((0x800U 
                                              ...
                                              | ((0x7e0U 
                                                 ...
                                                 | (0x1eU 
                                                    & (vlSelf->cpu__DOT__ins 
                                                       >> 7U))))));
    } else if ((3U == (IData)(vlSelf->cpu__DOT__u_decode__DOT__imm_src_d))) {
        vlSelf->cpu__DOT__imm_ext_d = ((vlSelf->cpu__DOT__ins 
                                        >> 0x1fU) ? 
                                       (0xffe00000U 
                                        | ((0x100000U 
                                           ...
                                           | ((0xff000U 
                                              ...
                                              | ((0x800U 
                                                 ...
                                                 | (0x7feU 
                                                    & (vlSelf->cpu__DOT__ins 
                                                       >> 0x14U))))));
    } else if (VL_LIKELY((4U == (IData)(vlSelf->cpu__DOT__u_decode__DOT__imm_src_d)))) {
        vlSelf->cpu__DOT__imm_ext_d = ((vlSelf->cpu__DOT__ins 
                                        >> 0x1fU) ? 
                                       (0xfff00000U 
                                        | (vlSelf->cpu__DOT__ins 
        ...
        VL_WRITEF("[%0t] %%Error: sign_extend.sv:37: Assertion failed in %Ncpu.u_decode.se: Immediate Module Error: imm_src value outside of range!\n",
                  64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
        VL_STOP_MT("../../rtl/sign_extend/sign_extend.sv", 37, "");
    }
