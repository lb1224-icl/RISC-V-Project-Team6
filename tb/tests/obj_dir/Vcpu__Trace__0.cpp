...
void Vcpu___024root__trace_chg_sub_0(Vcpu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgCData(oldp+36,((0x1fU & (vlSelf->cpu__DOT__ins 
                                          >> 7U))),5);
        bufp->chgCData(oldp+37,((7U & (vlSelf->cpu__DOT__ins 
                                       >> 0xcU))),3);
        bufp->chgCData(oldp+38,((0x7fU & vlSelf->cpu__DOT__ins)),7);
        bufp->chgCData(oldp+39,((vlSelf->cpu__DOT__ins 
                                 >> 0x19U)),7);
        ...
        bufp->chgCData(oldp+43,((0x1fU & (vlSelf->cpu__DOT__ins 
                                          >> 0x14U))),5);
        bufp->chgSData(oldp+44,((0x3fffU & vlSelf->cpu__DOT__pc_f)),14);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        bufp->chgBit(oldp+45,(vlSelf->cpu__DOT__reg_write_d));
        bufp->chgCData(oldp+46,(vlSelf->cpu__DOT__result_src_d),2);
        bufp->chgBit(oldp+47,(vlSelf->cpu__DOT__mem_write_d));
        bufp->chgBit(oldp+48,(vlSelf->cpu__DOT__pc_src));
        bufp->chgCData(oldp+49,(vlSelf->cpu__DOT__alu_control_d),4);
        bufp->chgBit(oldp+50,(vlSelf->cpu__DOT__alu_src_d));
        bufp->chgIData(oldp+51,(vlSelf->cpu__DOT__imm_ext_d),32);
        bufp->chgBit(oldp+52,(vlSelf->cpu__DOT__jalr));
        bufp->chgIData(oldp+53,(vlSelf->cpu__DOT__u_execute__DOT__alu_res),32);
        bufp->chgCData(oldp+54,(vlSelf->cpu__DOT__u_decode__DOT__imm_src_d),3);
        bufp->chgCData(oldp+55,(vlSelf->cpu__DOT__u_decode__DOT__cu__DOT__alu_logic),3);
        bufp->chgIData(oldp+56,(vlSelf->cpu__DOT__u_execute__DOT__src_b_e),32);
        bufp->chgIData(oldp+57,((0x1ffffU & vlSelf->cpu__DOT__u_execute__DOT__alu_res)),17);
    }
    bufp->chgBit(oldp+58,(vlSelf->clk));
    bufp->chgBit(oldp+59,(vlSelf->rst));
    bufp->chgIData(oldp+60,(vlSelf->a0),32);
    bufp->chgIData(oldp+61,(vlSelf->cpu__DOT__rd_1),32);
    bufp->chgIData(oldp+62,(vlSelf->cpu__DOT__rd_2),32);
    bufp->chgBit(oldp+63,(((0x4000U & vlSelf->cpu__DOT__ins)
                            ...
                            : ((~ (vlSelf->cpu__DOT__ins 
                                   >> 0xdU)) & ((0x1000U 
                                                ...
                                                (vlSelf->cpu__DOT__rd_1 
                                                 == vlSelf->cpu__DOT__u_execute__DOT__src_b_e))))));
    bufp->chgIData(oldp+64,(((IData)(vlSelf->cpu__DOT__jalr)
                              ? vlSelf->cpu__DOT__u_execute__DOT__alu_res
                              : (vlSelf->cpu__DOT__pc_f 
                                 + vlSelf->cpu__DOT__imm_ext_d))),32);
    bufp->chgIData(oldp+65,(((vlSelf->cpu__DOT__u_memory__DOT__data_mem__DOT__data_array
                              [(0x1ffffU & ((IData)(3U) 
                                            + vlSelf->cpu__DOT__u_execute__DOT__alu_res))] 
    ...
    bufp->chgIData(oldp+66,(((2U & (IData)(vlSelf->cpu__DOT__result_src_d))
                                      ...
                                      << 0x18U) | (
                                                   ...
                                                   | ((vlSelf->cpu__DOT__u_memory__DOT__data_mem__DOT__data_array
                                                      ...
                                                      (0x1ffffU 
                                                       & vlSelf->cpu__DOT__u_execute__DOT__alu_res)])))
                                  : vlSelf->cpu__DOT__u_execute__DOT__alu_res))),32);
    bufp->chgIData(oldp+67,((vlSelf->cpu__DOT__pc_f 
                             + vlSelf->cpu__DOT__imm_ext_d)),32);
    bufp->chgIData(oldp+68,(((IData)(vlSelf->cpu__DOT__pc_src)
